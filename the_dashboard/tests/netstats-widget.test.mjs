...
test("netstats preserves readings through failures and clears stale state after recovery", async () => {
  ...
  await withPatchedGlobals({
    ...
    assert.equal(instance.ipRow.classList.contains("severity-warn"), true);
    assert.equal(instance.chartWrap.classList.contains("severity-warn"), true);
    assert.equal(instance.speedBlock.classList.contains("severity-warn"), true);
    ...
    assert.equal(instance.ipRow.classList.contains("severity-warn"), false);
    assert.equal(instance.chartWrap.classList.contains("severity-warn"), false);
    assert.equal(instance.speedBlock.classList.contains("severity-warn"), false);
